...
def _get_collection():
    ...
    """
    import chromadb
    client = chromadb.PersistentClient(path=os.path.abspath(os.path.join(os.path.dirname(__file__), "../../chroma_db")))
    try:
        ...
        print(f"⚠️  Collection 'lab_rag' chưa có data. Chạy index script trong README trước.")
    return collection
